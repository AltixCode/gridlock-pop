...
`/Volumes/Dev/mobile_expo_apps/gridlock-pop` is a shared working tree sitting on whatever
...
that had been fixed hours earlier. Clone instead:
    ...
    gh repo clone AltixCode/gridlock-pop -- --depth 1
